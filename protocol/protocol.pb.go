...
type GetVideoInfoResponse struct {
	...
	VideoInfo *VidepInfo     `protobuf:"bytes,2,opt,name=videoInfo,proto3" json:"videoInfo,omitempty"`
}
...
func (x *GetVideoInfoResponse) GetVideoInfo() *VidepInfo {
	if x != nil {
		return x.VideoInfo
	}
	return nil
...
func (x *StartCollectLiveChatResponse) GetVideoInfo() *VidepInfo {
	if x != nil {
		return x.VideoInfo
	}
	return nil
...
type VidepInfo struct {
	...
	StatusPrivacyStatus string `protobuf:"bytes,13,opt,name=statusPrivacyStatus,proto3" json:"statusPrivacyStatus,omitempty"`
	StatusUploadStatus  string `protobuf:"bytes,14,opt,name=statusUploadStatus,proto3" json:"statusUploadStatus,omitempty"`
	StatusEmbeddable    string `protobuf:"bytes,15,opt,name=statusEmbeddable,proto3" json:"statusEmbeddable,omitempty"`
}

func (x *VidepInfo) Reset() {
	*x = VidepInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *VidepInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VidepInfo) ProtoMessage() {}

func (x *VidepInfo) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VidepInfo.ProtoReflect.Descriptor instead.
func (*VidepInfo) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{4}
}

func (x *VidepInfo) GetVideoId() string {
	if x != nil {
		return x.VideoId
	}
	return ""
...
func (x *VidepInfo) GetChannelId() string {
	if x != nil {
		return x.ChannelId
	}
	return ""
...
func (x *VidepInfo) GetCategoryId() string {
	if x != nil {
		return x.CategoryId
	}
	return ""
...
func (x *VidepInfo) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *VidepInfo) GetDescription() string {
	if x != nil {
...
func (x *VidepInfo) GetPublishedAt() string {
	if x != nil {
...
func (x *VidepInfo) GetDuration() string {
	if x != nil {
		return x.Duration
	}
	return ""
...
func (x *VidepInfo) GetActiveLiveChatId() string {
	if x != nil {
...
func (x *VidepInfo) GetActualStartTime() string {
	if x != nil {
...
func (x *VidepInfo) GetActualEndTime() string {
	if x != nil {
...
func (x *VidepInfo) GetScheduledStartTime() string {
	if x != nil {
...
func (x *VidepInfo) GetScheduledEndTime() string {
	if x != nil {
...
func (x *VidepInfo) GetStatusPrivacyStatus() string {
	if x != nil {
		return x.StatusPrivacyStatus
	}
	return ""
}

func (x *VidepInfo) GetStatusUploadStatus() string {
	if x != nil {
		return x.StatusUploadStatus
	}
	return ""
}

func (x *VidepInfo) GetStatusEmbeddable() string {
	if x != nil {
		return x.StatusEmbeddable
	}
	return ""
}
...
type ActiveLiveChatMessage struct {
	...
	LiveChatMessageListResponseEtag string `protobuf:"bytes,4,opt,name=liveChatMessageListResponseEtag,proto3" json:"liveChatMessageListResponseEtag,omitempty"`
	...
	AuthorProfileImageUrl           string `protobuf:"bytes,8,opt,name=authorProfileImageUrl,proto3" json:"authorProfileImageUrl,omitempty"`
	AuthorIsChatModerator           string `protobuf:"bytes,9,opt,name=authorIsChatModerator,proto3" json:"authorIsChatModerator,omitempty"`
	AuthorIsChatOwner               string `protobuf:"bytes,10,opt,name=authorIsChatOwner,proto3" json:"authorIsChatOwner,omitempty"`
	AuthorIsChatSponsor             string `protobuf:"bytes,11,opt,name=authorIsChatSponsor,proto3" json:"authorIsChatSponsor,omitempty"`
	AuthorIsVerified                string `protobuf:"bytes,12,opt,name=authorIsVerified,proto3" json:"authorIsVerified,omitempty"`
	LiveChatId                      string `protobuf:"bytes,13,opt,name=liveChatId,proto3" json:"liveChatId,omitempty"`
	DisplayMessage                  string `protobuf:"bytes,14,opt,name=displayMessage,proto3" json:"displayMessage,omitempty"`
	MessagePublishedAt              string `protobuf:"bytes,15,opt,name=messagePublishedAt,proto3" json:"messagePublishedAt,omitempty"`
	IsSuperChat                     bool   `protobuf:"varint,16,opt,name=isSuperChat,proto3" json:"isSuperChat,omitempty"`
	AmountDisplayString             string `protobuf:"bytes,17,opt,name=amountDisplayString,proto3" json:"amountDisplayString,omitempty"`
...
type LiveChatMessage struct {
	...
	AuthorPhotoUrlThumbnails string `protobuf:"bytes,7,opt,name=authorPhotoUrlThumbnails,proto3" json:"authorPhotoUrlThumbnails,omitempty"`
	MessageText              string `protobuf:"bytes,8,opt,name=messageText,proto3" json:"messageText,omitempty"`
	PurchaseAmountText       string `protobuf:"bytes,9,opt,name=purchaseAmountText,proto3" json:"purchaseAmountText,omitempty"`
	VideoOffsetTimeMsec      string `protobuf:"bytes,10,opt,name=videoOffsetTimeMsec,proto3" json:"videoOffsetTimeMsec,omitempty"`
}
...
func (x *LiveChatMessage) GetVideoId() string {
	if x != nil {
		return x.VideoId
	}
	return ""
...
var file_protocol_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x6c, 0x0a, 0x14, 0x47, 0x65,
	...
	0x0a, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0a, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x76,
	0x69, 0x64, 0x65, 0x6f, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x37, 0x0a, 0x1b, 0x53, 0x74, 0x61, 0x72,
	0x74, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74,
	...
	0x64, 0x22, 0x74, 0x0a, 0x1c, 0x53, 0x74, 0x61, 0x72, 0x74, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
	0x74, 0x4c, 0x69, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0a, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x76, 0x69,
	0x64, 0x65, 0x6f, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xbf, 0x04, 0x0a, 0x09, 0x56, 0x69, 0x64, 0x65,
	0x70, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x75, 0x73, 0x12, 0x3a, 0x0a, 0x0f, 0x6c, 0x69, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x4c,
	0x69, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x0f,
	0x6c, 0x69, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22,
	0x89, 0x03, 0x0a, 0x0f, 0x4c, 0x69, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73,
	...
	0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0d, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x55, 0x73, 0x65, 0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0d, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x55, 0x73, 0x65, 0x63, 0x12,
	...
	,
	...
	0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x6c, 0x79, 0x41, 0x63, 0x74, 0x69,
	0x76, 0x65, 0x4c, 0x69, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x43,
	0x68, 0x61, 0x74, 0x12, 0x13, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x43, 0x68, 0x61,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x69,
	...
	0x2f, 0x70, 0x6f, 0x74, 0x69, 0x78, 0x2f, 0x79, 0x6c, 0x63, 0x63, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_protocol_proto_goTypes = []interface{}{
	...
	(*VidepInfo)(nil),                         // 4: VidepInfo
	(*DeleteLiveChatRequest)(nil),             // 5: DeleteLiveChatRequest
	(*DeleteLiveChatResponse)(nil),            // 6: DeleteLiveChatResponse
	(*GetRecentlyActiveLiveChatRequest)(nil),  // 7: GetRecentlyActiveLiveChatRequest
	(*GetRecentlyActiveLiveChatResponse)(nil), // 8: GetRecentlyActiveLiveChatResponse
	(*ActiveLiveChatMessage)(nil),             // 9: ActiveLiveChatMessage
	(*GetLiveChatRequest)(nil),                // 10: GetLiveChatRequest
	(*GetLiveChatResponse)(nil),               // 11: GetLiveChatResponse
	(*LiveChatMessage)(nil),                   // 12: LiveChatMessage
	(*status.Status)(nil),                     // 13: google.rpc.Status
}
var file_protocol_proto_depIdxs = []int32{
	13, // 0: GetVideoInfoResponse.status:type_name -> google.rpc.Status
	4,  // 1: GetVideoInfoResponse.videoInfo:type_name -> VidepInfo
	13, // 2: StartCollectLiveChatResponse.status:type_name -> google.rpc.Status
	4,  // 3: StartCollectLiveChatResponse.videoInfo:type_name -> VidepInfo
	13, // 4: DeleteLiveChatResponse.status:type_name -> google.rpc.Status
	13, // 5: GetRecentlyActiveLiveChatResponse.status:type_name -> google.rpc.Status
	9,  // 6: GetRecentlyActiveLiveChatResponse.activeLiveChatMessages:type_name -> ActiveLiveChatMessage
	13, // 7: GetLiveChatResponse.status:type_name -> google.rpc.Status
	12, // 8: GetLiveChatResponse.liveChatMessage:type_name -> LiveChatMessage
	0,  // 9: ylcc.GetVideoInfo:input_type -> GetVideoInfoRequst
	2,  // 10: ylcc.StartCollectLiveChat:input_type -> StartCollectLiveChatRequest
	5,  // 11: ylcc.DeleteLiveChat:input_type -> DeleteLiveChatRequest
	7,  // 12: ylcc.GetRecentlyActiveLiveChat:input_type -> GetRecentlyActiveLiveChatRequest
	10, // 13: ylcc.GetLiveChat:input_type -> GetLiveChatRequest
	1,  // 14: ylcc.GetVideoInfo:output_type -> GetVideoInfoResponse
	3,  // 15: ylcc.StartCollectLiveChat:output_type -> StartCollectLiveChatResponse
	6,  // 16: ylcc.DeleteLiveChat:output_type -> DeleteLiveChatResponse
	8,  // 17: ylcc.GetRecentlyActiveLiveChat:output_type -> GetRecentlyActiveLiveChatResponse
	11, // 18: ylcc.GetLiveChat:output_type -> GetLiveChatResponse
